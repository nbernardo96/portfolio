        ...
        <div className="intro">
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            <li className="list-inline-item">
              <a rel="noreferrer" href="https://www.instagram.com/nicole.aestheticreations/" target='_blank'>
                <i className="fab fa-instagram"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a rel="noreferrer" href="https://www.linkedin.com/in/nicole-bernardo/" target='_blank'>
